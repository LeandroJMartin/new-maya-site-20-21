  ...
  <div class="container">
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="row middle imgmain">
        <div class="img">
          <img src="<?php echo DIRPORT; ?>/polimetal/01.webp" alt="Imagem" />
        </div>
        <div class="alter">
      ...
      <div class="gallery">
        ...
        <div class="row imgs">
          <div class="img">
            <img class="fit" src="<?php echo DIRPORT; ?>/polimetal/01.webp" alt="Imagem" />
          </div>
          <div class="img">
            <img class="fit" src="<?php echo DIRPORT; ?>/lionhard/01.webp" alt="Imagem" />
          </div>
          <div class="img">
            <img class="fit" src="<?php echo DIRPORT; ?>/polimetal/01.webp" alt="Imagem" />
          </div>
